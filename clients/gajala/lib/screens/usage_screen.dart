...
class _ProviderCard extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Text(
                  (p['provider'] ?? '?').toString().toUpperCase(),
                ...
                if (p['plan'] != null) ...[
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: GajalaColors.accentDim.withValues(alpha: .3),
            ...
            if (limits.isEmpty)
              Text(
                isLocal
                    ? 'Runs on your Mac · exact local tokens · no quota'
                    : hasTokens
  ...
  Widget _limitBar(String label, double pct, {String? detail}) => Builder(
    builder: (context) {
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text(
                detail != null ? '$detail · $pctStr%' : '$pctStr% used',
